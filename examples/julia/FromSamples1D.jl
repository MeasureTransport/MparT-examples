...
# ╔═╡ 326a628c-e6e3-11ee-0e95-7911cdc01219
begin
	ENV["KOKKOS_NUM_THREADS"] = 4
	using MParT, Distributions, Optimization, OptimizationOptimJL, GLMakie
end

# ╔═╡ 3ce00d57-6079-49db-8acc-84009bad9508
md"""
# One dimensional map from samples
"""

# ╔═╡ 212c76cb-c1af-4377-a2d5-42a2cf156b19
md"""
## Target distribution
We create an $\sinh$-$\mathrm{arc}\sinh$ distribution with a skew parameter
$s \in \mathbb{R}$, tail parameter $t > 0$
- When $s > 0$ leads to positive (right tilted) skew and $s < 0$ leads to negative (left tilted) skew
- When $t < 1$ leads to light tails, $t > 1$ leads to heavy tails.
- When $s = 0,\ t = 1$ leads to affine function $x = \mu + \sigma z$
See for more info: Jones, M. Chris, and Arthur Pewsey. "Sinh-arcsinh distributions." Biometrika 96.4 (2009): 761-780.
"""

# ╔═╡ a96cc1ad-037a-4a90-9dcb-07de57e270f1
...
# ╔═╡ 6c2a61f4-9e13-46fe-b5ef-d529da8c3d05
begin
	num_points = 1000
	z = randn(num_points)
...
# ╔═╡ 999fafa1-c0c5-47bf-b2d9-f439a4c02c58
begin # Before optimization
	num_bins = 50
	fig1 = Figure()
...
# ╔═╡ 4817d861-258b-4afa-8aa9-f6e54c103874
begin # Create multi-index set:
	multis = reshape(0:5, 6, 1)
	mset = MultiIndexSet(multis)
	fixed_mset = Fix(mset, true)
end

# ╔═╡ 9d1b774e-1c2d-47e2-8c94-69e4c23f5c5f
begin
...
# ╔═╡ e6cb9b52-f7e0-4ca1-bf4d-d308eac5f66f
...
# ╔═╡ 0d4bbd2d-05d9-4814-a905-47d4e349560b
begin
...
# ╔═╡ de10773a-2c52-4749-ad03-fe31f4993d93
begin
	## Optimize
...
# ╔═╡ 542b2f72-aed4-41b2-bba3-b804a0138c0c
begin # After optimization plot
	map_of_x = Evaluate(monotoneMap, x)
    fig2 = Figure()
...
manifest_format = "2.0"
project_hash = "25760fbf053348bde622e80b2983d403c7d85034"
...
git-tree-sha1 = "f8dcb327d89b4b6357bb24287c8ab753120f2740"
...
git-tree-sha1 = "d83d40d4553ac35482d51360735140b1a5818808"
uuid = "4383ffe1-dc98-4547-9515-b1eacdbc2dac"
version = "2.2.2"

[[deps.MParT_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "Kokkos_jll", "Libdl", "libcxxwrap_julia_jll"]
git-tree-sha1 = "c31519e13d41c52a88ae2f5f796a165c6e8c06e7"
...
git-tree-sha1 = "aaa2a9f4c9c5d573247dd74b80b2f3d18bbe51c7"
